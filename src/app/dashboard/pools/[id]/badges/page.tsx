    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900">Conquistas</h1>
          ...
          <div className="mb-5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {earned.map((badge) => (
                <div
                  key={badge.id}
                  className="bg-white rounded-2xl p-4 border border-purple-100 shadow-sm text-center"
                >
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {locked.map((badge) => (
                <div
                  key={badge.id}
                  className="bg-white rounded-2xl p-4 border border-slate-100 text-center opacity-60"
                >
        ...
        {badges.length === 0 && (
          <div className="bg-white rounded-2xl p-8 border border-slate-100 text-center">
            <p className="text-slate-500">Nenhuma conquista cadastrada ainda.</p>
          </div>
        )}
      </main>
    </div>
